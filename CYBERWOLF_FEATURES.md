...
about                   # ℹ️ Developer details
whoami                  # 🆔 Identity information
```

### 🗣️ Speech Commands
```bash
sp <text>              # 🗣️ Text-to-speech (auto speech)
...
The theme includes pre-configured AI integration:
- **API Key**: Pre-configured Gemini API access
- **Model**: gemini-2.0-flash for fast responses
- **Search**: `wolf search <query>` for AI assistance
- **Integration**: Seamless terminal AI experience

### AI Features
- **Intelligent Search**: Ask questions and get AI-powered answers
- **Context Awareness**: Understands cybersecurity and technical queries
- **Fast Response**: Optimized for real-time terminal use
